                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3>Water Source Sales</h3>
                            <p>Sales done under a specific water source</p>
                        </div>
                        <?php
                        ...
                        $query = "SELECT "
                                ...
                                . "WHERE " . DB_TABLE_PREFIX . "water_sources.id_water_source=$id_water_source ";
                                        ...
                                        <tbody>   
                                            ...
                                            foreach ($sales as $gross_sale) {
                                                ...
                                                if (empty($c_name)) {
                                                    ...
                                                    $c_name = '<a href="/manage/water-user-transactions/?id=' . $gross_sale['id_user'] . '"  data-toggle="tooltip" data-placement="top" title="Click To View User Payments History">' . $c_name . '</a>';
                                                }
