                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <p>Update a user access group</p>
                        </div>
                            ...
                            <form method="post" action="" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="group_name" id="group_name" class="form-control" placeholder="Group name" value="<?php echo $App->sanitizeVar($group, 'group_name'); ?>">
                                    </div>
                                </div>
                                <hr class="dashed">
                                <div class="row">
