                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3>Add build</h3>
                            <p>Upload a compiled app build for download</p>
                        </div>
                            ...
                            <form method="post"  action="" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="build_date" id="build_date" class="form-control datetimepicker" data-date-format="DD-MM-YYYY hh:mm A" placeholder="Build date" value="<?php echo $App->postValue('build_date'); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4"> 
                                        <label for="preferred" class="checkbox">
                                            <input type="checkbox" name="preferred" id="preferred" <?php echo isset($_POST['preferred']) && $_POST['preferred'] == 1 ? 'checked="checked"' : ""; ?> value="1" class="check">
                                            Preferred
                                        </label> 
                                    </div>
                                    <div class="col-md-4">
                                        <label for="is_stable" class="checkbox">
                                            <input type="checkbox" name="is_stable" id="is_stable" <?php echo isset($_POST['is_stable']) && $_POST['is_stable'] == 1 ? 'checked="checked"' : ""; ?> value="1" class="check">
                                            Stable
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="published" class="checkbox">
                                            <input type="checkbox" name="published" id="published" <?php echo isset($_POST['published']) && $_POST['published'] == 1 ? 'checked="checked"' : ""; ?> value="1" class="check">
                                            Published
                                        </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="control-label" for="build_file">Build date</label>
