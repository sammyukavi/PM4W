                                    ...
                                    <div class="col-md-6">  
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="expenditure_date" id="expenditure_date" class="form-control datetimepicker" data-date-format="DD-MM-YYYY hh:mm A" value="<?php echo isset($_POST['expenditure_date']) ? date('d-m-Y h:i A', strtotime($App->postValue('expenditure_date'))) : date('d-m-Y h:i A'); ?>">
                                            </div>                    
                                        </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="expenditure_cost" id="water_source_location" class="form-control" placeholder="UGX" value="<?php echo $App->postValue('expenditure_cost'); ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">                                                 
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="benefactor" id="benefactor" class="form-control" placeholder="Mechanic" value="<?php echo $App->postValue('benefactor'); ?>">
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="control-label" for="description">Description</label>
                                                <textarea name="description" id="description" class="form-control" rows="7" style="resize: none;"><?php echo $App->postValue('description'); ?></textarea>
                                            </div>
                                        </div>
