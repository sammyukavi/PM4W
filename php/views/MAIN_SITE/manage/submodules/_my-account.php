                            ...
                            <div class="row"> 
                                <form method="post" action="" autocomplete="off"> 
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="fname" id="fname" class="form-control" placeholder="First name" value="<?php echo $App->postValue('fname'); ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="control-label" for="email">Last name</label>
                                                <input type="text" name="lname" id="lname" class="form-control" placeholder="Last name" value="<?php echo $App->postValue('lname'); ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p>Leave the fields below blank if you don't want to change the password</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
