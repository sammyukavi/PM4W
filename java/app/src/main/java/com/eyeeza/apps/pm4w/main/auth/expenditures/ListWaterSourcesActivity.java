...
public class ListWaterSourcesActivity extends Activity {
    ...
    private ArrayList<HashMap<String, String>> waterSourcesArrayList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        waterSourcesListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent listWaterSourceExpendituresActivity = new Intent(getApplicationContext(), ListWaterSourceExpendituresActivity.class);
                listWaterSourceExpendituresActivity.putExtra(Constants.ID_WATER_SOURCE_TAG, waterSourceIdRenderer.getText());
                startActivity(listWaterSourceExpendituresActivity);
            }
