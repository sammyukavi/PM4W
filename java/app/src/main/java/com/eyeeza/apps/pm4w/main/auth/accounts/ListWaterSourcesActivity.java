...
public class ListWaterSourcesActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        waterSourcesListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String nextActivityName = getIntent().getStringExtra("nextActivity");
                Intent nextActivity;
                if (nextActivityName.equals("miniStatement")) {
                    nextActivity = new Intent(getApplicationContext(), MiniStatementActivity.class);
                } else {
                    nextActivity = new Intent(getApplicationContext(), ShowAccountBalanceActivity.class);
                }
                nextActivity.putExtra(Constants.ID_WATER_SOURCE_TAG, waterSourceIdRenderer.getText());
    ...
    class FetchWaterSources extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            Caretakers treasurer = new Caretakers(ListWaterSourcesActivity.this);
